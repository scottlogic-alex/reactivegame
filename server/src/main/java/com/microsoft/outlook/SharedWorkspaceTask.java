...
public interface SharedWorkspaceTask extends _IMsoDispObj {
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.MsoSharedWorkspaceTaskStatus
   */

  @DISPID(2) //= 0x2. The runtime will prefer the VTID if present
  @VTID(13)
  com.microsoft.outlook.MsoSharedWorkspaceTaskStatus status();
   ...
   * </p>
   * @param status Mandatory com.microsoft.outlook.MsoSharedWorkspaceTaskStatus parameter.
   */
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.MsoSharedWorkspaceTaskPriority
   */

  @DISPID(3) //= 0x3. The runtime will prefer the VTID if present
  @VTID(15)
  com.microsoft.outlook.MsoSharedWorkspaceTaskPriority priority();
   ...
   * </p>
   * @param priority Mandatory com.microsoft.outlook.MsoSharedWorkspaceTaskPriority parameter.
   */
  ...
  @VTID(20)
  void dueDate(
          @MarshalAs(NativeType.VARIANT) Object dueDate);
