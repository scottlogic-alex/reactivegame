...
public interface ContactCard extends com.microsoft.outlook._IMsoDispObj {
  // Methods:
  /**
   */
  ...
  /**
   * @param cardStyle Mandatory com.microsoft.outlook.MsoContactCardStyle parameter.
  ...
  @VTID(10)
  void show(
          com.microsoft.outlook.MsoContactCardStyle cardStyle,
          int rectangleLeft,
          int rectangleRight,
          int rectangleTop,
          int rectangleBottom,
