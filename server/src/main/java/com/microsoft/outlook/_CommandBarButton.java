...
public interface _CommandBarButton extends com.microsoft.outlook.CommandBarControl {
  // Methods:
  /**
   * <p>
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.MsoButtonState
   */
   ...
   * </p>
   * @param pstate Mandatory com.microsoft.outlook.MsoButtonState parameter.
   */

  @DISPID(1610940424) //= 0x60050008. The runtime will prefer the VTID if present
  @VTID(92)
  void state(
          MsoButtonState pstate);
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.MsoButtonStyle
   */
   ...
   * </p>
   * @param pstyle Mandatory com.microsoft.outlook.MsoButtonStyle parameter.
   */

  @DISPID(1610940426) //= 0x6005000a. The runtime will prefer the VTID if present
  @VTID(94)
  void style(
          MsoButtonStyle pstyle);
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.MsoCommandBarButtonHyperlinkType
   */

  @DISPID(1610940428) //= 0x6005000c. The runtime will prefer the VTID if present
  @VTID(95)
  com.microsoft.outlook.MsoCommandBarButtonHyperlinkType hyperlinkType();
   ...
   * </p>
   * @param phlType Mandatory com.microsoft.outlook.MsoCommandBarButtonHyperlinkType parameter.
   */

  @DISPID(1610940428) //= 0x6005000c. The runtime will prefer the VTID if present
  @VTID(96)
  void hyperlinkType(
          com.microsoft.outlook.MsoCommandBarButtonHyperlinkType phlType);
