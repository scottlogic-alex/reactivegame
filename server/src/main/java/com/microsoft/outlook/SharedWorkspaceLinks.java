...
public interface SharedWorkspaceLinks extends _IMsoDispObj,Iterable<Com4jObject> {
  // Methods:
  /**
   * <p>
   ...
   * @return  Returns a value of type com.microsoft.outlook.SharedWorkspaceLink
   */

  @DISPID(0) //= 0x0. The runtime will prefer the VTID if present
  @VTID(10)
  @DefaultMethod
  SharedWorkspaceLink item(
          int index);
  ...
  SharedWorkspaceLink add(
          ...
          @Optional @MarshalAs(NativeType.VARIANT) Object notes);
