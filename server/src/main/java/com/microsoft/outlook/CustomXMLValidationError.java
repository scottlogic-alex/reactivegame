...
public interface CustomXMLValidationError extends _IMsoDispObj {
  // Methods:
  /**
   * <p>
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.MsoCustomXMLValidationErrorType
   */

  @DISPID(1610809348) //= 0x60030004. The runtime will prefer the VTID if present
  @VTID(13)
  com.microsoft.outlook.MsoCustomXMLValidationErrorType type();
