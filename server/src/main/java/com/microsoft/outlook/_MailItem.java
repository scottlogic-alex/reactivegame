...
public interface _MailItem extends Com4jObject {
  ...
  @VTID(103)
  com.microsoft.outlook.Recipients replyRecipients();
  ...
  @VTID(104)
  com.microsoft.outlook.MAPIFolder saveSentMessageFolder();
  ...
  @VTID(136)
  com.microsoft.outlook.OlFlagIcon flagIcon();
  ...
  void addBusinessCard(
          com.microsoft.outlook._ContactItem contact);
  ...
  @VTID(169)
  com.microsoft.outlook.AddressEntry sender();
   ...
   * </p>
   * @param sender Mandatory com.microsoft.outlook.AddressEntry parameter.
   */
