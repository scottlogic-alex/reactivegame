...
public interface IFind extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.MsoFileFindOptions
   */

  @DISPID(1610743815) //= 0x60020007. The runtime will prefer the VTID if present
  @VTID(14)
  com.microsoft.outlook.MsoFileFindOptions options();
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.MsoFileFindView
   */

  @DISPID(1610743824) //= 0x60020010. The runtime will prefer the VTID if present
  @VTID(23)
  com.microsoft.outlook.MsoFileFindView view();
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.MsoFileFindSortBy
   */

  @DISPID(1610743825) //= 0x60020011. The runtime will prefer the VTID if present
  @VTID(24)
  com.microsoft.outlook.MsoFileFindSortBy sortBy();
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.MsoFileFindListBy
   */

  @DISPID(1610743826) //= 0x60020012. The runtime will prefer the VTID if present
  @VTID(25)
  com.microsoft.outlook.MsoFileFindListBy listBy();
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.IFoundFiles
   */

  @DISPID(1610743828) //= 0x60020014. The runtime will prefer the VTID if present
  @VTID(27)
  com.microsoft.outlook.IFoundFiles results();


  @VTID(27)
  @ReturnValue(defaultPropertyThrough={com.microsoft.outlook.IFoundFiles.class})
  String results(
          int index);
   ...
   * </p>
   * @param penmOptions Mandatory com.microsoft.outlook.MsoFileFindOptions parameter.
   */

  @DISPID(1610743815) //= 0x60020007. The runtime will prefer the VTID if present
  @VTID(36)
  void options(
          com.microsoft.outlook.MsoFileFindOptions penmOptions);
  ...
  @VTID(40)
  void dateSavedFrom(
          @MarshalAs(NativeType.VARIANT) Object pdatSavedFrom);
  ...
  @VTID(41)
  void dateSavedTo(
          @MarshalAs(NativeType.VARIANT) Object pdatSavedTo);
  ...
  void dateCreatedFrom(
          @MarshalAs(NativeType.VARIANT) Object pdatCreatedFrom);
  ...
  @VTID(44)
  void dateCreatedTo(
          @MarshalAs(NativeType.VARIANT) Object pdatCreatedTo);
   ...
   * </p>
   * @param penmView Mandatory com.microsoft.outlook.MsoFileFindView parameter.
   */

  @DISPID(1610743824) //= 0x60020010. The runtime will prefer the VTID if present
  @VTID(45)
  void view(
          com.microsoft.outlook.MsoFileFindView penmView);
   ...
   * </p>
   * @param penmSortBy Mandatory com.microsoft.outlook.MsoFileFindSortBy parameter.
   */

  @DISPID(1610743825) //= 0x60020011. The runtime will prefer the VTID if present
  @VTID(46)
  void sortBy(
          com.microsoft.outlook.MsoFileFindSortBy penmSortBy);
   ...
   * </p>
   * @param penmListBy Mandatory com.microsoft.outlook.MsoFileFindListBy parameter.
   */

  @DISPID(1610743826) //= 0x60020012. The runtime will prefer the VTID if present
  @VTID(47)
  void listBy(
          com.microsoft.outlook.MsoFileFindListBy penmListBy);
