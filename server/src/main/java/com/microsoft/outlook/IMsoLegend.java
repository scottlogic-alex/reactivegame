...
public interface IMsoLegend extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.XlLegendPosition
   */

  @DISPID(133) //= 0x85. The runtime will prefer the VTID if present
  @VTID(14)
  com.microsoft.outlook.XlLegendPosition position();
   ...
   * </p>
   * @param rhs Mandatory com.microsoft.outlook.XlLegendPosition parameter.
   */

  @DISPID(133) //= 0x85. The runtime will prefer the VTID if present
  @VTID(15)
  void position(
          com.microsoft.outlook.XlLegendPosition rhs);
