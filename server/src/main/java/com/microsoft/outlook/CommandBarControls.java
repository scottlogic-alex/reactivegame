...
public interface CommandBarControls extends _IMsoDispObj,Iterable<Com4jObject> {
  // Methods:
  /**
  ...
  CommandBarControl add(
          ...
          @Optional @MarshalAs(NativeType.VARIANT) Object parameter,
