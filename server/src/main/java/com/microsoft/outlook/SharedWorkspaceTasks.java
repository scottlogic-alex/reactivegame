...
public interface SharedWorkspaceTasks extends _IMsoDispObj,Iterable<Com4jObject> {
  // Methods:
  /**
   * <p>
   ...
   * @return  Returns a value of type com.microsoft.outlook.SharedWorkspaceTask
   */

  @DISPID(0) //= 0x0. The runtime will prefer the VTID if present
  @VTID(9)
  @DefaultMethod
  SharedWorkspaceTask item(
          int index);
  ...
  SharedWorkspaceTask add(
          String title,
          @Optional @MarshalAs(NativeType.VARIANT) Object status,
          @Optional @MarshalAs(NativeType.VARIANT) Object priority,
          @Optional @MarshalAs(NativeType.VARIANT) Object assignee,
          @Optional @MarshalAs(NativeType.VARIANT) Object description,
          @Optional @MarshalAs(NativeType.VARIANT) Object dueDate);
