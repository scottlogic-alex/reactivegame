...
public interface MetaProperty extends _IMsoDispObj {
  // Methods:
  /**
   * <p>
  ...
  @DefaultMethod
  void value(
          @MarshalAs(NativeType.VARIANT) Object pvarValue);
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.MsoMetaPropertyType
   */

  @DISPID(5) //= 0x5. The runtime will prefer the VTID if present
  @VTID(15)
  com.microsoft.outlook.MsoMetaPropertyType type();
