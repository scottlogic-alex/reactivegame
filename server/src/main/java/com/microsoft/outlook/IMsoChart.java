...
public interface IMsoChart extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.IMsoChartTitle
   */

  @DISPID(1610743811) //= 0x60020003. The runtime will prefer the VTID if present
  @VTID(10)
  com.microsoft.outlook.IMsoChartTitle chartTitle();
  ...
  @VTID(22)
  void rightAngleAxes(
          @MarshalAs(NativeType.VARIANT) Object pvarRightAngleAxes);
  ...
  @VTID(24)
  void rotation(
          @MarshalAs(NativeType.VARIANT) Object pvarRotation);
   ...
   * </p>
   * @param pres Mandatory com.microsoft.outlook.XlDisplayBlanksAs parameter.
   */

  @DISPID(1610743826) //= 0x60020012. The runtime will prefer the VTID if present
  @VTID(25)
  void displayBlanksAs(
          com.microsoft.outlook.XlDisplayBlanksAs pres);
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.XlDisplayBlanksAs
   */

  @DISPID(1610743826) //= 0x60020012. The runtime will prefer the VTID if present
  @VTID(26)
  com.microsoft.outlook.XlDisplayBlanksAs displayBlanksAs();
  ...
  void protect(
          @Optional @MarshalAs(NativeType.VARIANT) Object password,
          @Optional @MarshalAs(NativeType.VARIANT) Object drawingObjects,
          @Optional @MarshalAs(NativeType.VARIANT) Object contents,
          @Optional @MarshalAs(NativeType.VARIANT) Object scenarios,
          @Optional @MarshalAs(NativeType.VARIANT) Object userInterfaceOnly);
  ...
  @VTID(39)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject chartGroups(
          @Optional Object pvarIndex,
          @Optional @MarshalAs(NativeType.VARIANT) Object varIgallery,
          @LCID int lcid);
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.IMsoCorners
   */

  @DISPID(79) //= 0x4f. The runtime will prefer the VTID if present
  @VTID(46)
  com.microsoft.outlook.IMsoCorners corners();
  ...
  void applyCustomType(
          com.microsoft.outlook.XlChartType chartType,
          @Optional @MarshalAs(NativeType.VARIANT) Object typeName);
  ...
  void setSourceData(
          String source,
          @Optional @MarshalAs(NativeType.VARIANT) Object plotBy);
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.XlRowCol
   */
   ...
   * </p>
   * @param plotBy Mandatory com.microsoft.outlook.XlRowCol parameter.
   */
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.IMsoLegend
   */

  @DISPID(84) //= 0x54. The runtime will prefer the VTID if present
  @VTID(59)
  com.microsoft.outlook.IMsoLegend legend();
  ...
  @VTID(61)
  void hasAxis(
          @Optional @MarshalAs(NativeType.VARIANT) Object axisType,
          @Optional @MarshalAs(NativeType.VARIANT) Object axisGroup,
   ...
   * @return  Returns a value of type com.microsoft.outlook.IMsoWalls
   */

  @DISPID(1610743864) //= 0x60020038. The runtime will prefer the VTID if present
  @VTID(63)
  com.microsoft.outlook.IMsoWalls walls(
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.IMsoFloor
   */

  @DISPID(1610743865) //= 0x60020039. The runtime will prefer the VTID if present
  @VTID(64)
  com.microsoft.outlook.IMsoFloor floor();
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.IMsoPlotArea
   */

  @DISPID(1610743866) //= 0x6002003a. The runtime will prefer the VTID if present
  @VTID(65)
  com.microsoft.outlook.IMsoPlotArea plotArea();
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.IMsoChartArea
   */

  @DISPID(1610743869) //= 0x6002003d. The runtime will prefer the VTID if present
  @VTID(68)
  com.microsoft.outlook.IMsoChartArea chartArea();
  ...
  void autoFormat(
          int rGallery,
          @Optional @MarshalAs(NativeType.VARIANT) Object varFormat);
  ...
  @VTID(73)
  void chartWizard(
          @Optional @MarshalAs(NativeType.VARIANT) Object varSource,
          @Optional @MarshalAs(NativeType.VARIANT) Object varGallery,
          @Optional @MarshalAs(NativeType.VARIANT) Object varFormat,
          @Optional @MarshalAs(NativeType.VARIANT) Object varPlotBy,
          @Optional @MarshalAs(NativeType.VARIANT) Object varCategoryLabels,
          @Optional @MarshalAs(NativeType.VARIANT) Object varSeriesLabels,
          @Optional @MarshalAs(NativeType.VARIANT) Object varHasLegend,
          @Optional @MarshalAs(NativeType.VARIANT) Object varTitle,
          @Optional @MarshalAs(NativeType.VARIANT) Object varCategoryTitle,
          @Optional @MarshalAs(NativeType.VARIANT) Object varValueTitle,
          @Optional @MarshalAs(NativeType.VARIANT) Object varExtraTitle,
          @LCID int localeID);
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.IMsoDataTable
   */

  @DISPID(1610743876) //= 0x60020044. The runtime will prefer the VTID if present
  @VTID(75)
  com.microsoft.outlook.IMsoDataTable dataTable();
  ...
  @ReturnValue(type=NativeType.VARIANT)
  Object evaluate(
          @MarshalAs(NativeType.VARIANT) Object varName,
          int localeID,
  ...
  @VTID(78)
  void paste(
          @Optional @MarshalAs(NativeType.VARIANT) Object varType,
          @LCID int localeID);
   ...
   * </p>
   * @param pShape Mandatory com.microsoft.outlook.XlBarShape parameter.
   */

  @DISPID(1610743880) //= 0x60020048. The runtime will prefer the VTID if present
  @VTID(80)
  void barShape(
          com.microsoft.outlook.XlBarShape pShape);
  ...
  boolean export(
          String bstr,
          @Optional @MarshalAs(NativeType.VARIANT) Object varFilterName,
          @Optional @MarshalAs(NativeType.VARIANT) Object varInteractive);
  ...
  @VTID(85)
  com.microsoft.outlook.IMsoWalls sideWall();
  ...
  @VTID(86)
  com.microsoft.outlook.IMsoWalls backWall();
  ...
  void applyLayout(
          int layout,
          @Optional @MarshalAs(NativeType.VARIANT) Object varChartType);
  ...
  /**
   * @param rhs Mandatory com.microsoft.outlook.MsoChartElementType parameter.
   */

  @DISPID(1610743900) //= 0x6002005c. The runtime will prefer the VTID if present
  @VTID(99)
  void setElement(
          com.microsoft.outlook.MsoChartElementType rhs);
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.IMsoChartData
   */

  @DISPID(1610743901) //= 0x6002005d. The runtime will prefer the VTID if present
  @VTID(100)
  com.microsoft.outlook.IMsoChartData chartData();
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.Shapes
   */
   ...
   * </p>
   * @param lcid Mandatory int parameter.
   * @return  Returns a value of type com.microsoft.outlook.IMsoChartGroup
   */

  @DISPID(17) //= 0x11. The runtime will prefer the VTID if present
  @VTID(105)
  com.microsoft.outlook.IMsoChartGroup area3DGroup(
          @LCID int lcid);
  ...
  @VTID(107)
  com.microsoft.outlook.IMsoChartGroup bar3DGroup(
          @LCID int lcid);
  ...
  @VTID(109)
  com.microsoft.outlook.IMsoChartGroup column3DGroup(
          @LCID int lcid);
  ...
  @VTID(111)
  com.microsoft.outlook.IMsoChartGroup line3DGroup(
          @LCID int lcid);
  ...
  @VTID(113)
  com.microsoft.outlook.IMsoChartGroup pie3DGroup(
          @LCID int lcid);
  ...
  @VTID(117)
  com.microsoft.outlook.IMsoChartGroup surfaceGroup(
          @LCID int lcid);
  ...
  @VTID(133)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject fullSeriesCollection(
          @Optional @MarshalAs(NativeType.VARIANT) Object index);
   ...
   * </p>
   * @param plevel Mandatory com.microsoft.outlook.XlCategoryLabelLevel parameter.
   */

  @DISPID(237) //= 0xed. The runtime will prefer the VTID if present
  @VTID(134)
  void categoryLabelLevel(
          com.microsoft.outlook.XlCategoryLabelLevel plevel);
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.XlCategoryLabelLevel
   */

  @DISPID(237) //= 0xed. The runtime will prefer the VTID if present
  @VTID(135)
  com.microsoft.outlook.XlCategoryLabelLevel categoryLabelLevel();
   ...
   * </p>
   * @param plevel Mandatory com.microsoft.outlook.XlSeriesNameLevel parameter.
   */

  @DISPID(238) //= 0xee. The runtime will prefer the VTID if present
  @VTID(136)
  void seriesNameLevel(
          com.microsoft.outlook.XlSeriesNameLevel plevel);
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.XlSeriesNameLevel
   */

  @DISPID(238) //= 0xee. The runtime will prefer the VTID if present
  @VTID(137)
  com.microsoft.outlook.XlSeriesNameLevel seriesNameLevel();
  ...
  @VTID(147)
  boolean displayValueNotAvailableAsBlank();
  ...
  @DISPID(1610743948) //= 0x6002008c. The runtime will prefer the VTID if present
  @VTID(148)
  void displayValueNotAvailableAsBlank(
          boolean res);
