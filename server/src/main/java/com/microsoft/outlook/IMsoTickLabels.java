...
public interface IMsoTickLabels extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.XlTickLabelOrientation
   */

  @DISPID(1610743818) //= 0x6002000a. The runtime will prefer the VTID if present
  @VTID(17)
  com.microsoft.outlook.XlTickLabelOrientation orientation();
   ...
   * </p>
   * @param pval Mandatory com.microsoft.outlook.XlTickLabelOrientation parameter.
   */

  @DISPID(1610743818) //= 0x6002000a. The runtime will prefer the VTID if present
  @VTID(18)
  void orientation(
          com.microsoft.outlook.XlTickLabelOrientation pval);
