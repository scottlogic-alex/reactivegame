...
public interface ShadowFormat extends _IMsoDispObj {
   ...
   * </p>
   * @param obscured Mandatory com.microsoft.outlook.MsoTriState parameter.
   */
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.MsoShadowType
   */

  @DISPID(105) //= 0x69. The runtime will prefer the VTID if present
  @VTID(22)
  com.microsoft.outlook.MsoShadowType type();
   ...
   * </p>
   * @param type Mandatory com.microsoft.outlook.MsoShadowType parameter.
   */
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.MsoShadowStyle
   */

  @DISPID(107) //= 0x6b. The runtime will prefer the VTID if present
  @VTID(26)
  com.microsoft.outlook.MsoShadowStyle style();
   ...
   * </p>
   * @param shadowStyle Mandatory com.microsoft.outlook.MsoShadowStyle parameter.
   */

  @DISPID(107) //= 0x6b. The runtime will prefer the VTID if present
  @VTID(27)
  void style(
          com.microsoft.outlook.MsoShadowStyle shadowStyle);
   ...
   * </p>
   * @param rotateWithShape Mandatory com.microsoft.outlook.MsoTriState parameter.
   */
