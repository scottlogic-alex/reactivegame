...
public interface PictureFormat extends _IMsoDispObj {
  // Methods:
  /**
   * <p>
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.MsoPictureColorType
   */

  @DISPID(101) //= 0x65. The runtime will prefer the VTID if present
  @VTID(14)
  com.microsoft.outlook.MsoPictureColorType colorType();
   ...
   * </p>
   * @param colorType Mandatory com.microsoft.outlook.MsoPictureColorType parameter.
   */
   ...
   * </p>
   * @param transparentBackground Mandatory com.microsoft.outlook.MsoTriState parameter.
   */
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.Crop
   */
