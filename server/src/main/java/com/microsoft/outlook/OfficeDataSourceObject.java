...
public interface OfficeDataSourceObject extends Com4jObject {
  ...
  /**
   * @param msoMoveRow Mandatory com.microsoft.outlook.MsoMoveRow parameter.
  ...
  @VTID(17)
  void open(
          @Optional @DefaultValue("") String bstrSrc,
          @Optional @DefaultValue("") String bstrConnect,
          @Optional @DefaultValue("") String bstrTable,
  ...
  void setSortOrder(
          ...
          @Optional @DefaultValue("") String sortField2,
          @Optional @DefaultValue("-1") boolean sortAscending2,
          @Optional @DefaultValue("") String sortField3,
