...
public interface IAccessible extends Com4jObject {
  ...
  @VTID(9)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject accChild(
          @MarshalAs(NativeType.VARIANT) Object varChild);
  ...
  @VTID(10)
  String accName(
          @Optional @MarshalAs(NativeType.VARIANT) Object varChild);
  ...
  Object accNavigate(
          int navDir,
          @Optional @MarshalAs(NativeType.VARIANT) Object varStart);
