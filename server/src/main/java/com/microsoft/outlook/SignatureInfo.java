...
public interface SignatureInfo extends _IMsoDispObj {
  ...
  /**
   * @param sigdet Mandatory com.microsoft.outlook.SignatureDetail parameter.
  ...
  Object getSignatureDetail(
          com.microsoft.outlook.SignatureDetail sigdet);


  /**
   * @param certdet Mandatory com.microsoft.outlook.CertificateDetail parameter.
   * @return  Returns a value of type java.lang.Object
   */
  ...
  @VTID(18)
  @ReturnValue(type=NativeType.VARIANT)
  Object getCertificateDetail(
          com.microsoft.outlook.CertificateDetail certdet);
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.ContentVerificationResults
   */

  @DISPID(8) //= 0x8. The runtime will prefer the VTID if present
  @VTID(19)
  com.microsoft.outlook.ContentVerificationResults contentVerificationResults();
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.CertificateVerificationResults
   */

  @DISPID(9) //= 0x9. The runtime will prefer the VTID if present
  @VTID(20)
  com.microsoft.outlook.CertificateVerificationResults certificateVerificationResults();
