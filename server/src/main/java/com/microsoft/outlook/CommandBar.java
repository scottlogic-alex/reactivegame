...
public interface CommandBar extends com.microsoft.outlook._IMsoOleAccDispObj {
  // Methods:
  /**
   * <p>
  ...
  com.microsoft.outlook.CommandBarControl findControl(
          ...
          @Optional @MarshalAs(NativeType.VARIANT) Object recursive);
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.MsoBarPosition
   */

  @DISPID(1610874899) //= 0x60040013. The runtime will prefer the VTID if present
  @VTID(49)
  com.microsoft.outlook.MsoBarPosition position();
   ...
   * </p>
   * @param ppos Mandatory com.microsoft.outlook.MsoBarPosition parameter.
   */

  @DISPID(1610874899) //= 0x60040013. The runtime will prefer the VTID if present
  @VTID(50)
  void position(
          com.microsoft.outlook.MsoBarPosition ppos);
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.MsoBarProtection
   */

  @DISPID(1610874903) //= 0x60040017. The runtime will prefer the VTID if present
  @VTID(53)
  com.microsoft.outlook.MsoBarProtection protection();
   ...
   * </p>
   * @param pprot Mandatory com.microsoft.outlook.MsoBarProtection parameter.
   */

  @DISPID(1610874903) //= 0x60040017. The runtime will prefer the VTID if present
  @VTID(54)
  void protection(
          com.microsoft.outlook.MsoBarProtection pprot);
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.MsoBarType
   */

  @DISPID(1610874909) //= 0x6004001d. The runtime will prefer the VTID if present
  @VTID(59)
  com.microsoft.outlook.MsoBarType type();
