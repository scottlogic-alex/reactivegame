...
public interface SharedWorkspaceFolders extends _IMsoDispObj,Iterable<Com4jObject> {
  // Methods:
  /**
   * <p>
   ...
   * @return  Returns a value of type com.microsoft.outlook.SharedWorkspaceFolder
   */

  @DISPID(0) //= 0x0. The runtime will prefer the VTID if present
  @VTID(10)
  @DefaultMethod
  SharedWorkspaceFolder item(
          int index);
