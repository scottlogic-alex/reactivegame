...
public interface _SolutionsModule extends Com4jObject {
  ...
  /**
   * @param solution Mandatory com.microsoft.outlook.MAPIFolder parameter.
   * @param scope Mandatory com.microsoft.outlook.OlSolutionScope parameter.
   */
