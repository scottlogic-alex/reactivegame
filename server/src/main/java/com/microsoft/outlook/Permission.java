...
public interface Permission extends com.microsoft.outlook._IMsoDispObj,Iterable<Com4jObject> {
  // Methods:
  /**
   * <p>
   ...
   * @return  Returns a value of type com.microsoft.outlook.UserPermission
   */

  @DISPID(0) //= 0x0. The runtime will prefer the VTID if present
  @VTID(9)
  @DefaultMethod
  com.microsoft.outlook.UserPermission item(
  ...
  @VTID(13)
  com.microsoft.outlook.UserPermission add(
          String userId,
          @Optional @MarshalAs(NativeType.VARIANT) Object permission,
          @Optional @MarshalAs(NativeType.VARIANT) Object expirationDate);
