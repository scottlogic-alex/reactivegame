...
public interface _IconView extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.OlIconViewType
   */

  @DISPID(64362) //= 0xfb6a. The runtime will prefer the VTID if present
  @VTID(31)
  com.microsoft.outlook.OlIconViewType iconViewType();
   ...
   * </p>
   * @param iconViewType Mandatory com.microsoft.outlook.OlIconViewType parameter.
   */
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.OlIconViewPlacement
   */

  @DISPID(64363) //= 0xfb6b. The runtime will prefer the VTID if present
  @VTID(33)
  com.microsoft.outlook.OlIconViewPlacement iconPlacement();
   ...
   * </p>
   * @param iconPlacement Mandatory com.microsoft.outlook.OlIconViewPlacement parameter.
   */
