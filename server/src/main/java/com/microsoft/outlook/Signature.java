...
public interface Signature extends com.microsoft.outlook._IMsoDispObj {
  // Methods:
  /**
   * <p>
  ...
  @VTID(21)
  void sign(
          @Optional @MarshalAs(NativeType.VARIANT) Object varSigImg,
          @Optional @MarshalAs(NativeType.VARIANT) Object varDelSuggSigner,
          @Optional @MarshalAs(NativeType.VARIANT) Object varDelSuggSignerLine2,
          @Optional @MarshalAs(NativeType.VARIANT) Object varDelSuggSignerEmail);
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.SignatureInfo
   */

  @DISPID(1610809357) //= 0x6003000d. The runtime will prefer the VTID if present
  @VTID(22)
  com.microsoft.outlook.SignatureInfo details();
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.SignatureSetup
   */

  @DISPID(1610809360) //= 0x60030010. The runtime will prefer the VTID if present
  @VTID(25)
  com.microsoft.outlook.SignatureSetup setup();
