...
public interface CommandBarControl extends com.microsoft.outlook._IMsoOleAccDispObj {
  // Methods:
  /**
   * <p>
  ...
  CommandBarControl copy(
          @Optional @MarshalAs(NativeType.VARIANT) Object bar,
          @Optional @MarshalAs(NativeType.VARIANT) Object before);
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.MsoControlOLEUsage
   */

  @DISPID(1610874904) //= 0x60040018. The runtime will prefer the VTID if present
  @VTID(54)
  com.microsoft.outlook.MsoControlOLEUsage oleUsage();
   ...
   * </p>
   * @param pcou Mandatory com.microsoft.outlook.MsoControlOLEUsage parameter.
   */

  @DISPID(1610874904) //= 0x60040018. The runtime will prefer the VTID if present
  @VTID(55)
  void oleUsage(
          com.microsoft.outlook.MsoControlOLEUsage pcou);
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.MsoControlType
   */
