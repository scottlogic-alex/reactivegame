...
public interface _Categories extends Com4jObject {
   ...
   * @return  Returns a value of type com.microsoft.outlook._Category
   */
  ...
  _Category add(
          String name,
          @Optional @MarshalAs(NativeType.VARIANT) Object color,
          @Optional @MarshalAs(NativeType.VARIANT) Object shortcutKey);
