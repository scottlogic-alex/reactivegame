...
public interface IMsoChartGroup extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.IMsoDownBars
   */
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.IMsoDropLines
   */
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.IMsoHiLoLines
   */
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.IMsoSeriesLines
   */

  @DISPID(1610743834) //= 0x6002001a. The runtime will prefer the VTID if present
  @VTID(33)
  com.microsoft.outlook.IMsoSeriesLines seriesLines();
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.IMsoUpBars
   */
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.XlSizeRepresents
   */

  @DISPID(1610743842) //= 0x60020022. The runtime will prefer the VTID if present
  @VTID(41)
  com.microsoft.outlook.XlSizeRepresents sizeRepresents();
   ...
   * </p>
   * @param pXlSizeRepresents Mandatory com.microsoft.outlook.XlSizeRepresents parameter.
   */

  @DISPID(1610743842) //= 0x60020022. The runtime will prefer the VTID if present
  @VTID(42)
  void sizeRepresents(
          com.microsoft.outlook.XlSizeRepresents pXlSizeRepresents);
   ...
   * </p>
   * @param pChartSplitType Mandatory com.microsoft.outlook.XlChartSplitType parameter.
   */

  @DISPID(1610743848) //= 0x60020028. The runtime will prefer the VTID if present
  @VTID(47)
  void splitType(
          com.microsoft.outlook.XlChartSplitType pChartSplitType);
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.XlChartSplitType
   */

  @DISPID(1610743848) //= 0x60020028. The runtime will prefer the VTID if present
  @VTID(48)
  com.microsoft.outlook.XlChartSplitType splitType();
  ...
  @VTID(50)
  void splitValue(
          @MarshalAs(NativeType.VARIANT) Object pSplitValue);
  ...
  @VTID(58)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject categoryCollection(
          @Optional @MarshalAs(NativeType.VARIANT) Object index);
  ...
  @VTID(59)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject fullCategoryCollection(
          @Optional @MarshalAs(NativeType.VARIANT) Object index);
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.XlBinsType
   */
   ...
   * </p>
   * @param rhs Mandatory com.microsoft.outlook.XlBinsType parameter.
   */
