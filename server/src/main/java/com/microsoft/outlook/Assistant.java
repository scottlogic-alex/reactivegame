...
public interface Assistant extends com.microsoft.outlook._IMsoDispObj {
  // Methods:
  /**
   * <p>
  ...
  /**
   * @param wizardID Mandatory int parameter.
   * @param act Mandatory com.microsoft.outlook.MsoWizardActType parameter.
   * @param animation Optional parameter. Default value is com4j.Variant.getMissing()
   */
  ...
  void activateWizard(
          int wizardID,
          com.microsoft.outlook.MsoWizardActType act,
          @Optional @MarshalAs(NativeType.VARIANT) Object animation);
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.Balloon
   */
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.MsoBalloonErrorType
   */

  @DISPID(1610809356) //= 0x6003000c. The runtime will prefer the VTID if present
  @VTID(21)
  com.microsoft.outlook.MsoBalloonErrorType balloonError();
   ...
   * @param alb Mandatory com.microsoft.outlook.MsoAlertButtonType parameter.
   * @param alc Mandatory com.microsoft.outlook.MsoAlertIconType parameter.
   * @param ald Mandatory com.microsoft.outlook.MsoAlertDefaultType parameter.
   * @param alq Mandatory com.microsoft.outlook.MsoAlertCancelType parameter.
  ...
  int doAlert(
          ...
          com.microsoft.outlook.MsoAlertButtonType alb,
          com.microsoft.outlook.MsoAlertIconType alc,
          com.microsoft.outlook.MsoAlertDefaultType ald,
          com.microsoft.outlook.MsoAlertCancelType alq,
