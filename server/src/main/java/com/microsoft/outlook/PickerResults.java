...
public interface PickerResults extends _IMsoDispObj,Iterable<Com4jObject> {
  // Methods:
  /**
   * <p>
   ...
   * @return  Returns a value of type com.microsoft.outlook.PickerResult
   */
  ...
  PickerResult add(
          ...
          String displayName,
          String type,
          @Optional @DefaultValue("") String sipId,
          @Optional @MarshalAs(NativeType.VARIANT) Object itemData,
          @Optional @MarshalAs(NativeType.VARIANT) Object subItems);
