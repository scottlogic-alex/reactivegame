...
public interface SignatureSet extends _IMsoDispObj,Iterable<Com4jObject> {
  // Methods:
  /**
   * <p>
   ...
   * @return  Returns a value of type com.microsoft.outlook.Signature
   */
  ...
  @VTID(15)
  Signature addNonVisibleSignature(
          @Optional @MarshalAs(NativeType.VARIANT) Object varSigProv);
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.MsoSignatureSubset
   */

  @DISPID(1610809353) //= 0x60030009. The runtime will prefer the VTID if present
  @VTID(18)
  com.microsoft.outlook.MsoSignatureSubset subset();
   ...
   * </p>
   * @param psubset Mandatory com.microsoft.outlook.MsoSignatureSubset parameter.
   */

  @DISPID(1610809353) //= 0x60030009. The runtime will prefer the VTID if present
  @VTID(19)
  void subset(
          com.microsoft.outlook.MsoSignatureSubset psubset);
