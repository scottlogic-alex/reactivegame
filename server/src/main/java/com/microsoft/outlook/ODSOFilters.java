...
public interface ODSOFilters extends com.microsoft.outlook._IMsoDispObj {
  // Methods:
  /**
   * <p>
   ...
   * @param comparison Mandatory com.microsoft.outlook.MsoFilterComparison parameter.
   * @param conjunction Mandatory com.microsoft.outlook.MsoFilterConjunction parameter.
  ...
  void add(
          ...
          @Optional @DefaultValue("") String bstrCompareTo,
