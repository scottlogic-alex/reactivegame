...
public interface ReflectionFormat extends _IMsoDispObj {
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.MsoReflectionType
   */

  @DISPID(1) //= 0x1. The runtime will prefer the VTID if present
  @VTID(9)
  com.microsoft.outlook.MsoReflectionType type();
   ...
   * </p>
   * @param type Mandatory com.microsoft.outlook.MsoReflectionType parameter.
   */
