...
public interface DiagramNodeChildren extends _IMsoDispObj,Iterable<Com4jObject> {
  // Methods:
  /**
   * <p>
  ...
  @VTID(11)
  DiagramNode addNode(
          @Optional @DefaultValue("-1") @MarshalAs(NativeType.VARIANT) Object index,
          @Optional @DefaultValue("1") MsoDiagramNodeType nodeType);
