...
public interface IMsoTrendline extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.XlTrendlineType
   */

  @VTID(34)
  com.microsoft.outlook.XlTrendlineType type();
   ...
   * </p>
   * @param rhs Mandatory com.microsoft.outlook.XlTrendlineType parameter.
   */

  @VTID(35)
  void type(
          com.microsoft.outlook.XlTrendlineType rhs);
