...
public interface ChartFillFormat extends Com4jObject {
  ...
  @VTID(12)
  void userPicture(
          @MarshalAs(NativeType.VARIANT) Object pictureFile,
          @MarshalAs(NativeType.VARIANT) Object pictureFormat,
          @MarshalAs(NativeType.VARIANT) Object pictureStackUnit,
          @MarshalAs(NativeType.VARIANT) Object picturePlacement);
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.ChartColorFormat
   */

  @DISPID(1610743816) //= 0x60020008. The runtime will prefer the VTID if present
  @VTID(15)
  com.microsoft.outlook.ChartColorFormat backColor();
  ...
  @VTID(16)
  com.microsoft.outlook.ChartColorFormat foreColor();
