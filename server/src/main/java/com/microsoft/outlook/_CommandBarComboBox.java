...
public interface _CommandBarComboBox extends CommandBarControl {
   ...
   * </p>
   * @return  Returns a value of type com.microsoft.outlook.MsoComboStyle
   */
   ...
   * </p>
   * @param pstyle Mandatory com.microsoft.outlook.MsoComboStyle parameter.
   */

  @DISPID(1610940430) //= 0x6005000e. The runtime will prefer the VTID if present
  @VTID(98)
  void style(
          MsoComboStyle pstyle);
